%160511 section 4 divided into 4 and 7, definition of third quadrant residual sets adjusted (same outcome), 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Section 1.3 COORDINATE CHANGES
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% Sec 23 Rounding Functions-2
%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Rounding functions-2} 
...
%%%%%%%%%%%%%%%%%%%%%%%%
% Lemma 4.1 Characterizing the residual set
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%
% Lemma 4.2 Characterizing the Residual set
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%
% Lemma 4.3 Necessary conditions $u>1, v>1$
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%
% Defn 4.6 full and reduced Beatty sequence
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Section 5  Third quadrant; residual set criterion
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%
% SECTION 5.1 Third quadrant RESIDUAL  Set
%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%
% Lemma 51 Characterizing the third quadrant residual set
%%%%%%%%%%%%%%%%%%%%%%
...
%$ \frac{1}{\uu}\ceil{\uu n} -\frac{1}{\uu}\leq \frac{\vv}{\uu} \ceil{\frac{\uu}{\vv} n}- \frac{\vv}{\uu}$ holds for all $n \in\ZZ.$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% 5.2 Connection to first quadrant
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{enumerate}
\end{enumerate}
%Solutions on hyperbolas are confined to  the region $\frac{u}{v} >1$.
We consider these possibilities in the next three subsections.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% 5.4 empty intersections- part 1
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% or $\frac{u}{v}  >  1$.
%%%%%%%%%%%%%%%%%%%%%%%%
% Lemma 5.3 Beatty sequence  0< u <1
%%%%%%%%%%%%%%%%%%%%%%
...
%Thus all solutions not covered by (a) must satisfy the restriction on $\uu$ given in (b).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% 5.5 empty intersections- part 2
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Sub-sub-section 5.5.1 u/v irrational
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Sub-sub-section 5.5.2 u/v irrational, u rational case
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% we have that the reduced Beatty sequences are disjoint $\sB_0(u_2)\cap\sB_0(v_2) = \emptyset$. In terms of first-quadrant residual sets $R_v^\pm = \cup_{n\in \sB_0(v)} (n, n+1)$, this means
% \[R_{u_2}^\pm \cap R_{v_2}^\pm = \emptyset \]
% are disjoint. But given two disjoint open sets, they will remain disjoint after taking the closure of {\em one} of the two sets. So
% \[ R_{u_2}^\pm \cap (R_{v_2}^\pm)^{cl} = R_{u_2}^\pm \cap \bar{R}_{v_2} =\emptyset.\]
\end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Sect. 5.5 EMPTY INTERSECTION: $u/v \ge 1$,  $u% rational
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% 7 Beatty Sequences, Torus subgps
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Sect. 4.3 Intersecting REDUCED BEATTY SEQUENCES
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%and requires additional ideas. [CURRENTLY INCOMPLETE] 
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Sect. 4.4 PROOF OF THEOREM 4.10
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Sub-sub-section 4.4.4 Sporadic case
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% SECT 4.5 Proof of Propostion  3.1 from Section 3\ref{prop:31}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{proof}
%[Proof of Proposition \ref{prop:31}}
...
%%%%%%%%%%%%%%%%%%%%%%%%
% Lemma 5.5 Beatty sequence classification 
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Sect. 5.7 Proof of Proposition 3.2
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Proof of Proposition \ref{prop:32} }\label{sec;56}

%We deduce Proposition \ref{prop:32} using  earlier results in this section.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 %
% Section 5.8 sporadic rational solutions
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Sporadic Rational Solutions: Case $\frac{\uu}{\vv} >1$}\label{sec:57}
